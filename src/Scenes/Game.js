...
import { Plant, redShroom, snowTree, cactus } from "./Plant";
...
export class GameScene extends Phaser.Scene {
    ...
    winConditionCheck() {
        return Object.values(this.inventory).reduce((sum, value) => sum + value, 0) >= 10;
    }
    ...
    update() {
        ...
        if (this.winConditionCheck()) {
            this.add.text(320, 320, "Space Conquered!", { color: "#ff0000" }).setScrollFactor(0);
        }
